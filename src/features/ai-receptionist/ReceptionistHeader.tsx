          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
            ...
            <div className="flex items-center gap-3 sm:shrink-0">
              <div className="text-right">
                <p className="text-xs font-medium text-text-primary">{ai.enabled ? "Active" : "Paused"}</p>
                <p className="text-[11px] text-text-muted">Master control</p>
              </div>
              <Switch checked={ai.enabled} onCheckedChange={requestToggle} aria-label="AI receptionist enabled" />
            </div>
          </div>
